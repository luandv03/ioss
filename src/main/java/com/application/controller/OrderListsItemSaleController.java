...
public class OrderListsItemSaleController implements Initializable {

    private static OrderListsItemSaleController instance;

    public Button createOrderListItemBtn;
    ...
    public static OrderListsItemSaleController getInstance() {
        if (instance == null) {
            instance = new OrderListsItemSaleController();
        }
        return instance;
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        createOrderListItemBtn.setOnAction(event -> showOrderListItemCreate());
...
//            String status = orderListItemStatus.getOrderListItemStatus(orderListItemSite.getStatus());
    ...
    public void showOrderListItemCreate() {
        Model.getInstance().getViewFactory().getSelectedMenuItem().set("OrderListItemCreate");
    }
